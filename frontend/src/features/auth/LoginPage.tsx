		...
		<div className="auth-page">
			...
			<aside className="auth-hero">
				...
				<p className="auth-hero__tagline">
					A plataforma completa para gestao de Trabalhos de Conclusao
					de Curso.
				</p>
				...
				<ul className="auth-hero__features">
					...
					<li>
						...
						<span>
							Relatorios inteligentes e indicadores em tempo real
						</span>
					</li>
					<li>
						<span className="auth-hero__feature-icon">
						...
						<span>
							Comunicacao integrada entre alunos, orientadores e
							banca
						</span>
					</li>
				</ul>
			...
			<div className="auth-content">
				<form className="auth-card" onSubmit={handleSubmit(onSubmit)}>
					...
					<p className="auth-footnote">
						Acesso para Coordenacao, Aluno e Professor Avaliador.
					</p>
				</form>
			</div>
		</div>
